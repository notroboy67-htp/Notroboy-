...
# 10) Exit
#
# NRB changes are menu/branding/prompt changes. The called
# Pterodactyl Panel + Wings installer contains the installation
    ...
    while true; do
        ...
        case "$choice" in
            ...
            2)
                ...
                ;;
            3) return ;;
            *) warn "Invalid option. Please choose 1-3."; sleep 1 ;;
        esac
    done
}
...
service_menu() {
    while true; do
        ...
        case "$choice" in
            ...
            16) return ;;
            *) warn "Invalid option. Please choose 1-16."; sleep 1 ;;
        esac
    done
}
    ...
    while true; do
        ...
        case "$choice" in
            ...
            11)
                ...
                ;;
            12) return ;;
            *) warn "Invalid option. Please choose 1-12."; sleep 1 ;;
        esac
    done
}
